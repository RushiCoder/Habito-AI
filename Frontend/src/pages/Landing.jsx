    ...
    <div className="min-h-screen">
      <header className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-lg">Habito AI</span>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-10 md:pt-16 pb-16">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-6 items-center">
          ...
          <div className="lg:col-span-4 order-1 lg:order-2 flex justify-center lg:ml-12">
            <OrbitingHabits />
          </div>
        </div>
      ...
      <footer className="max-w-6xl mx-auto px-6 py-8 text-center text-xs text-faint border-t divider">
        Built with MERN · Habito AI © {new Date().getFullYear()}
      </footer>
    </div>
  );
}
